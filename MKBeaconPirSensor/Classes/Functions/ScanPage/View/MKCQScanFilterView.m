...
@interface MKCQScanFilterView ()<UIGestureRecognizerDelegate>
...
@property (nonatomic, copy)void (^searchBlock)(NSString *searchName, NSString *macAddress, NSInteger searchRssi);

@end

@implementation MKCQScanFilterView

- (void)dealloc{
    NSLog(@"MKCQScanFilterView销毁");
}
...
+ (void)showSearchName:(NSString *)name
    ...
    MKCQScanFilterView *view = [[MKCQScanFilterView alloc] init];
...
- (MKTextField *)macTextField {
    if (!_macTextField) {
        _macTextField = [[MKTextField alloc] initWithTextFieldType:mk_normal];
...
- (UIImageView *)signalIcon{
    if (!_signalIcon) {
        _signalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(offset_X,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _signalIcon.image = LOADICON(@"MKBeaconPirSensor", @"MKCQScanFilterView", @"cq_wifiSignalIcon.png");
    }
    return _signalIcon;
}
...
- (UIImageView *)graySignalIcon {
    if (!_graySignalIcon) {
        _graySignalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(backViewWidth - offset_X - signalIconWidth,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _graySignalIcon.image = LOADICON(@"MKBeaconPirSensor", @"MKCQScanFilterView", @"cq_wifiGraySignalIcon.png");
    }
