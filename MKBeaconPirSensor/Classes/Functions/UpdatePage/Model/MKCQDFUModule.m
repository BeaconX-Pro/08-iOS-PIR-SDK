...
@interface MKCQDFUModule()<LoggerDelegate, DFUServiceDelegate, DFUProgressDelegate>
...
@implementation MKCQDFUModule

- (void)dealloc{
    NSLog(@"MKCQDFUModule销毁");
}
...
- (void)updateWithFileUrl:(NSString *)url
    ...
    self.dfuController = [initiator startWithTarget:[MKCQCentralManager shared].peripheral];
}
