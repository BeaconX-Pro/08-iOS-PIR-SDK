...
@interface MKCQUpdateController ()<UITableViewDelegate,UITableViewDataSource,UIDocumentPickerDelegate>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKCQDFUModule *dfuModule;
...
@implementation MKCQUpdateController
...
- (void)startDFUWithFilePath:(NSString *)filePath {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_cq_startDfuProcessNotification" object:nil];
...
- (void)updateComplete {
    ...
    [MKCQCentralManager sharedDealloc];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_cq_centralDeallocNotification" object:nil];
...
- (MKCQDFUModule *)dfuModule {
    if (!_dfuModule) {
        _dfuModule = [[MKCQDFUModule alloc] init];
    }
    return _dfuModule;
}
