...
@implementation MKCQAboutController

- (void)dealloc {
    NSLog(@"MKCQAboutController销毁");
}
...
- (UILabel *)appNameLabel{
    if (!_appNameLabel) {
        ...
        _appNameLabel.text = @"PIRMotionSensor";
    }
...
- (UIImageView *)aboutIcon{
    if (!_aboutIcon) {
        ...
        _aboutIcon.image = LOADICON(@"MKBeaconPirSensor", @"MKCQAboutController", @"cq_aboutIcon.png");
    }
    return _aboutIcon;
}
