...
/**
 线程ID
 */
@property (nonatomic, assign)mk_cq_taskOperationID operationID;
...
- (instancetype)initOperationWithID:(mk_cq_taskOperationID)operationID
...
- (void)peripheral:(CBPeripheral *)peripheral didUpdateValueForCharacteristic:(CBCharacteristic *)characteristic {
    [self dataParserReceivedData:[MKCQTaskAdopter parseReadDataWithCharacteristic:characteristic]];
}

- (void)peripheral:(CBPeripheral *)peripheral didWriteValueForCharacteristic:(CBCharacteristic *)characteristic {
    [self dataParserReceivedData:[MKCQTaskAdopter parseWriteDataWithCharacteristic:characteristic]];
}
...
- (void)dataParserReceivedData:(NSDictionary *)dataDic{
    ...
    mk_cq_taskOperationID operationID = [dataDic[@"operationID"] integerValue];
    if (operationID == mk_cq_defaultTaskOperationID || operationID != self.operationID) {
        return;
    }
...
//    if (operationID == mk_cq_taskReadHundredHistoryDataOperation) {
//        //历史数据是多包数据
